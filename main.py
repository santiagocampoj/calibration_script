    ...
    for subfolder in tqdm(audio_folders, desc='Processing folders'):
        ...
        for audio_file in tqdm(audio_files, desc='Processing audio files'):
            try:
                ...
                data, fs = soundfile.read(full_audio_path) # fixing bugg 
                ...
                for start_idx in range(0, len(data) - window_size + 1, window_size):
                    ...
                    levels, freqs = PyOctaveBand_reduced.third_octave_filter(segment, fs, order=6, show=0, sigbands=0, calibration_coeff=calibration_coeff)
